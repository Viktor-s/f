 ...
 */
class Version20160226085137 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE product_pdp_intellectual_element (id INT NOT NULL, expression_id INT NOT NULL, input_id INT NOT NULL, prepend_text TEXT DEFAULT NULL, append_text TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_983028C6ADBB65A1 ON product_pdp_intellectual_element (expression_id)');
        $this->addSql('CREATE INDEX IDX_983028C636421AD6 ON product_pdp_intellectual_element (input_id)');
        ...
        $this->addSql('ALTER TABLE product_pdp_intellectual_element ADD CONSTRAINT FK_983028C636421AD6 FOREIGN KEY (input_id) REFERENCES product_pdp_input (id) ON DELETE RESTRICT NOT DEFERRABLE INITIALLY IMMEDIATE');
