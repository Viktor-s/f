...
use Sylius\Bundle\FixturesBundle\DataFixtures\ORM\LoadProductArchetypeData as BaseLoadProductArchetypeData;

class LoadProductArchetypeData extends BaseLoadProductArchetypeData
{
    /**
     * {@inheritdoc}
     */
